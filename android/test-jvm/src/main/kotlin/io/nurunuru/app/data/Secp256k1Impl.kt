...
internal object Secp256k1Impl {
    ...
    fun schnorrSign(msg: ByteArray, privKey: ByteArray, aux: ByteArray?): ByteArray {
        ...
        val t = d.to32Bytes().xorWith(taggedHash("BIP0340/aux", auxRand))
        val randHash = taggedHash("BIP0340/nonce", t + P.x.to32Bytes() + msg)
        ...
        val e = BigInteger(1, taggedHash("BIP0340/challenge", Rx + Px + msg)).mod(N)
