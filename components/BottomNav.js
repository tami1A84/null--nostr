...
const tabs = [
  ...
  },
  {
    ...
    icon: (active) => (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill={active ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth={active ? 0 : 1.8}>
        {active ? (
          <path d="M21 7H3a2 2 0 00-2 2v10a2 2 0 002 2h18a2 2 0 002-2V9a2 2 0 00-2-2zm-3 9a2 2 0 110-4 2 2 0 010 4zM4 5a2 2 0 012-2h12a2 2 0 012 2v2H4V5z"/>
        ) : (
          <path strokeLinecap="round" strokeLinejoin="round" d="M3 7h18M5 3h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2zm12 10a2 2 0 100-4 2 2 0 000 4z"/>
        )}
      </svg>
    )
  }
