...
export function getCachedMutualFollows(pubkey) {
  return getCache(`mutualfollows_${pubkey}`)
}

export function setCachedMutualFollows(pubkey, mutualFollows) {
  setCache(`mutualfollows_${pubkey}`, mutualFollows, CACHE_DURATION.followList)
}
